...
import { StateDiscovery } from "../../features/stores/components/StateDiscovery";
import { StoreStats } from "../../features/stores/components/StoreStats";
import { StoreExperience } from "../../features/stores/components/StoreExperience";
...
export default function StoreLocatorPage() {
  return (
    <main className="min-h-screen bg-white selection:bg-amber-100 antialiased">
      ...
      {/* State-by-State Footprint Corporate Breakdown Panels */}
      <StateDiscovery />
