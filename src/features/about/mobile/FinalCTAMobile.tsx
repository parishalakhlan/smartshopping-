...
export function FinalCTAMobile() {
  ...
  return (
    <section
      id="brand-invitation"
      className="py-12 bg-[#163B65] text-white px-5 relative overflow-hidden"
    >
      ...
      <motion.div
        ...
        className={`w-full max-w-md mx-auto border cursor-pointer select-none overflow-hidden relative group transition-colors duration-300 ${
          isExpanded
            ? "bg-[#0F2D52] border-white/20"
            : "bg-[#1E4A7C]/40 border-white/10"
        }`}
      >
        ...
        <div className="p-5 flex flex-col justify-center min-h-[72px]">
          ...
          <div className="w-full flex justify-between items-center gap-4">
            <div className="space-y-0.5">
              <span className="text-[9px] font-sans font-bold tracking-[0.2em] text-[#F97316] block uppercase">
            ...
            <span className="text-xs font-mono font-bold shrink-0 text-[#F97316] pr-1">
              {isExpanded ? "—" : "+"}
            </span>
          </div>
              ...
              >
                ...
                <div className="flex flex-col gap-2.5 pt-5 pb-1 w-full font-sans">
                  <a
                    ...
                    onClick={(e) => e.stopPropagation()} // Prevents collapsing when tapping links
                    className="w-full h-11 inline-flex items-center justify-center bg-[#F97316] active:bg-[#EA580C] text-white text-[11px] font-bold tracking-widest transition-colors duration-200 uppercase"
                  >
