...
export function CompanyStatsMobile() {
  ...
  return (
    <section id="the-impact" className="py-16 px-5 bg-[#F5F2EC]">
                ...
                <div className="w-full flex justify-between items-center gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center font-mono text-xs font-bold transition-all duration-300 ${
                        isSelected
                          ...
                          : "bg-[#F5F2EC] text-[#163B65] group-hover:bg-[#163B65] group-hover:text-white"
                      }`}
                    >
                      {item.metric}
                    </div>
                    ...
                    <div className="space-y-0.5">
                      <span
                        className={`text-[9px] font-bold uppercase tracking-widest block opacity-60 ${isSelected ? "text-[#F5F2EC]" : "text-[#475569]"}`}
                      >
                        {item.label}
                      </span>
                      <h3
                        className={`font-serif text-base font-bold tracking-tight ${isSelected ? "text-white" : "text-[#163B65]"}`}
                      >
                        {item.heading}
                      </h3>
                    </div>
                  ...
                  <span
                    className={`text-xs font-mono font-bold shrink-0 pr-1 ${isSelected ? "text-[#F97316]" : "text-[#163B65]/40"}`}
                  >
                    {isSelected ? "—" : "+"}
                  </span>
                </div>
                  ...
                  {isSelected && (
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        className={`w-full h-[1px] mt-4 origin-left ${isSelected ? "bg-white/20" : "bg-[#163B65]/10"}`}
                      />
                      ...
                      <div className="relative max-h-[160px] overflow-y-auto mt-4 pr-1 scrollbar-none">
                        <p className="font-sans text-xs sm:text-sm text-[#F5F2EC]/90 leading-relaxed font-normal pb-4">
                          {item.story}
                        </p>
