        ...
        <div className="space-y-16 lg:space-y-24 w-full">
          {IMPACT_NARRATIVES.map((item, idx) => (
            <motion.div
              ...
              className="grid grid-cols-12 gap-12 items-start border-t border-[#163B65]/10 pt-8 group"
            >
              <div className="col-span-5 flex flex-col items-start">
                <span className="font-serif text-3xl lg:text-4xl text-[#163B65] font-bold tracking-tight block mb-2 transition-colors duration-300 group-hover:text-[#F97316]">
                  {item.heading}
                </span>
              ...
              <div className="col-span-7 max-w-2xl">
                <p className="font-sans text-[#475569] text-lg leading-relaxed font-normal">
                  {item.story}
                </p>
              </div>
            </motion.div>
