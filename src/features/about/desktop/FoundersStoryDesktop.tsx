        ...
        <div className="grid grid-cols-12 gap-16 lg:gap-20 items-center">
          ...
          >
            <div className="space-y-3">
              ...
              <h2 className="font-serif text-4xl lg:text-5xl text-[#163B65] font-bold tracking-tight leading-[1.15]">
            ...
            <div className="border-t border-[#163B65]/10 pt-6">
              ...
              <AnimatePresence initial={false}>
                {isExpanded && (
                  ...
                  >
                    <div className="pt-4 text-base text-[#475569]/90 space-y-4 leading-relaxed max-w-2xl">
