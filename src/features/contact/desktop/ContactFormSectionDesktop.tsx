  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto px-8 text-left">
        ...
        <div className="bg-[#FFFFFF] border border-[#163B65]/10 p-8 min-h-[380px] flex flex-col justify-between">
          {formSuccess ? (
            <motion.div
            ...
            >
              ...
              <p className="text-[#475569] text-xs max-w-sm mx-auto leading-relaxed">
                  ...
                  {formStep === 2 && (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[10px] bg-[#F5F2EC] text-[#F97316] px-2 py-0.5 font-mono font-bold">
                          {roleType}
                        </span>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            className="w-full text-xs p-3 border border-[#163B65]/10 rounded-none focus:outline-none focus:border-[#163B65]"
                          />
                        </div>
                        <div className="space-y-1">
                          <span className="text-[11px] text-[#475569] font-medium block">
                      ...
                      <div className="flex justify-between items-center pt-4 border-t border-[#163B65]/5">
                        <button
                          type="button"
                          onClick={() => setFormStep(1)}
                          className="text-[10px] font-bold text-[#163B65]/60 uppercase tracking-wider flex items-center gap-1 hover:text-[#163B65]"
                        >
                        ...
                        <button
                          ...
                          className="px-6 py-3 bg-[#163B65] text-[#FFFFFF] text-[10px] font-bold uppercase tracking-wider flex items-center gap-2 hover:bg-[#112F52] disabled:opacity-30"
                        >
                    ...
                    >
                      ...
                      <div className="space-y-1">
                        ...
                        <textarea
                          ...
                          className="w-full text-xs p-3 border border-[#163B65]/10 rounded-none focus:outline-none focus:border-[#163B65] resize-none"
                        />
                      </div>
                      ...
                      <div className="flex justify-between items-center pt-4 border-t border-[#163B65]/5">
                        <button
                          ...
                          className="text-[10px] font-bold text-[#163B65]/60 uppercase tracking-wider flex items-center gap-1 hover:text-[#163B65] disabled:opacity-30"
                        >
                          <ArrowLeft className="w-3.5 h-3.5" /> Back
                        </button>
                        <button
                          ...
                          className="px-8 py-3.5 bg-[#F97316] text-[#FFFFFF] text-[10px] font-bold uppercase tracking-wider flex items-center gap-2 hover:bg-[#E0640F] disabled:opacity-30"
                        >
                          {isSubmitting ? (
                            <>
