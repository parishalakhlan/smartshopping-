    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-8 text-center space-y-8 relative z-10">
        <div className="space-y-3">
          ...
          <p className="text-[#FFFFFF]/70 text-sm font-normal max-w-md mx-auto leading-relaxed">
        ...
        <div className="flex gap-4 justify-center items-center">
          <MagneticButton className="px-8 py-4 bg-[#F97316] text-[#FFFFFF] hover:bg-[#E26613] border border-[#F97316] font-bold text-sm rounded-none">
            Apply Now
          </MagneticButton>
          <MagneticButton className="px-8 py-4 bg-transparent text-[#FFFFFF] border border-[#FFFFFF]/20 hover:border-[#FFFFFF] text-sm rounded-none transition-all">
            Contact Recruitment
          </MagneticButton>
        </div>
      </div>
