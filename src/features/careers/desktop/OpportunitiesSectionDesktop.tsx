              ...
              filteredJobs.map((job) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`bg-[#FFFFFF] border transition-all rounded-none overflow-hidden text-left ${
                      isExpanded
                    ...
                    >
                      <div className="space-y-1">
                        <div className="flex flex-wrap items-center gap-2">
                          <span className="text-[9px] uppercase tracking-wider font-bold bg-[#F5F2EC] text-[#163B65] px-2 py-0.5">
                            {job.department}
                          </span>
                        ...
                        >
                          <div className="p-6 space-y-6">
                            <div className="space-y-1.5">
                              ...
                              <p className="text-xs text-[#475569] font-normal leading-relaxed max-w-2xl">
                                {job.overview}
                              </p>
                            </div>
                            ...
                            <div className="space-y-2">
                              ...
                              <ul className="list-disc list-inside space-y-1 text-xs text-[#475569] font-normal pl-1">
                            ...
                            <div className="pt-4 border-t border-[#163B65]/10">
