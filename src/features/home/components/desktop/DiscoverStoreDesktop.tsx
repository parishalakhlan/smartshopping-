        ...
        <div className="grid grid-cols-12 gap-8 mb-24 items-end">
          ...
          <div className="col-span-4 text-right">
            <motion.a
              href={config.ctaLink}
              whileHover={{ x: 6 }}
              className="inline-flex items-center gap-x-3 font-sans text-sm font-bold tracking-widest uppercase text-[#163B65] group transition-all"
            >
          ...
          {config.destinations.map((dest, idx) => (
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="font-sans text-xs text-[#475569] font-normal uppercase tracking-wider">
                  {dest.location}
                </span>
              </div>
            </motion.div>
