    ...
    <section className="py-32 bg-[#FFFFFF] overflow-hidden hidden md:block">
      <div className="max-w-7xl mx-auto px-8 lg:px-12">
        <div className="grid grid-cols-12 gap-16 lg:gap-24 items-start">
          ...
          <div className="col-span-5 relative aspect-[3/4] w-full bg-[#F5F2EC] overflow-hidden">
            <motion.div
          ...
          <div className="col-span-7 flex flex-col justify-start pt-4">
            ...
            <h2 className="font-serif text-5xl lg:text-6xl text-[#163B65] font-bold tracking-tight leading-[1.1] mb-10">
              {config.heading}
            </h2>

            <div className="font-sans text-[#475569] text-base lg:text-lg leading-relaxed max-w-2xl space-y-6">
              ...
              <AnimatePresence initial={false}>
                {isExpanded && (
                  ...
                  >
                    <p className="pt-6 border-t border-[#F5F2EC] text-[#475569] font-normal">
              ...
              <div className="pt-8">
                <motion.button
                  ...
                  whileHover={{ gap: "16px" }}
                  className="inline-flex items-center gap-3 font-sans text-sm font-bold tracking-widest uppercase text-[#163B65] group transition-all"
                >
                  <span>{isExpanded ? "Read Less" : "Expand Narrative"}</span>
                  <div className="w-9 h-9 rounded-full bg-[#F5F2EC] flex items-center justify-center text-[#163B65] group-hover:bg-[#163B65] group-hover:text-[#FFFFFF] transition-colors duration-300">
                    {isExpanded ? (
