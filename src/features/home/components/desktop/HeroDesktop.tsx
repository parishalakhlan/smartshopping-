...
export default function HeroDesktop({ data }: { data: HeroData }) {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-[#163B65] hidden md:flex">
      ...
      <div className="absolute inset-0 z-0 select-none pointer-events-none">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#0F172A] via-[#163B65]/75 to-transparent" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-8 lg:px-12 py-32 flex flex-col justify-center min-h-screen">
        <motion.div
          ...
          className="max-w-5xl"
        >
          <span className="inline-block text-[#F97316] font-sans font-medium tracking-[0.3em] text-sm uppercase mb-8">
            {data.tagline}
          </span>
          ...
          <p className="font-sans text-xl lg:text-2xl text-[#F5F2EC]/80 font-normal mb-14 max-w-2xl leading-relaxed">
            {data.description}
          </p>
          ...
          <div className="flex items-center gap-8">
            <motion.a
              ...
              className="inline-flex items-center justify-center bg-[#FFFFFF] text-[#163B65] font-sans text-sm tracking-wider font-bold px-12 py-6 rounded-none shadow-md transition-colors hover:bg-[#F5F2EC]"
            >
            ...
            >
              ...
              <ArrowRight className="w-5 h-5 text-[#F97316] transition-transform group-hover:translate-x-1" />
            </motion.a>
          </div>
        </motion.div>
      </div>
