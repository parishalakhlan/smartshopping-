    ...
    <section className="py-32 bg-[#FFFFFF] overflow-hidden hidden md:block">
      <div className="max-w-7xl mx-auto px-8 lg:px-12">
        <div className="grid grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          <div className="col-span-6 relative aspect-[4/5] w-full bg-[#F5F2EC] overflow-hidden">
            <motion.div
            ...
            <div className="absolute bottom-8 left-8 bg-white/95 backdrop-blur-md px-5 py-3.5 shadow-sm inline-flex items-center gap-x-3">
              ...
              <p className="font-sans text-xs font-bold tracking-wider uppercase text-[#163B65]">
          ...
          <div className="col-span-6 flex flex-col justify-center">
            ...
            <h2 className="font-serif text-5xl text-[#163B65] font-bold tracking-tight leading-[1.1] mb-8">
              {config.heading}
            </h2>

            <p className="font-sans text-[#475569] text-base lg:text-lg mb-12 leading-relaxed max-w-xl">
              {config.description}
            </p>

            {/* Configured Metrics Metadata */}
            <div className="border-t border-[#F5F2EC] pt-10 mb-12 grid grid-cols-2 gap-8 w-full font-sans">
              {config.highlights.map((highlight, idx) => (
                <div key={idx}>
                  <h4 className="font-bold text-[#0F172A] text-xs uppercase tracking-widest mb-3">
                    {highlight.title}
                  </h4>
            ...
            <div className="flex items-center gap-x-10">
              ...
              <Link
                href="/contact"
                className="font-sans text-sm font-bold tracking-widest uppercase text-[#475569] hover:text-[#0F172A] transition-colors py-2 border-b border-transparent hover:border-[#0F172A]"
              >
