      ...
      <div className="px-5">
        ...
        <div className="space-y-12">
          {config.philosophies.map((philosophy, idx) => (
            <div
              key={idx}
              className="flex flex-col border-t border-[#163B65]/10 pt-6 whitespace-normal break-words"
            >
              <div className="font-sans text-[10px] font-bold tracking-widest text-[#F97316] uppercase mb-2">
                0{idx + 1}
              </div>

              <h3 className="font-serif text-xl text-[#163B65] font-bold tracking-wide mb-3">
                {philosophy.title}
              </h3>
