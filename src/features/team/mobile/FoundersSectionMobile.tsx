...
import { Sparkles, Anchor, Quote } from "lucide-react";
      ...
      <div className="space-y-6">
        {founders.map((founder) => {
          ...
          return (
            <div
              key={founder.id}
              className="w-full border-b border-[#163B65]/5 last:border-none pb-6 last:pb-0"
            >
              {/* Trigger Header Row */}
              <div
                onClick={() =>
              ...
              >
                ...
                <motion.div
                  ...
                  className="relative w-20 h-24 shrink-0 bg-[#F5F2EC] overflow-hidden border border-[#163B65]/10"
                >
                  <Image
                    src={founder.image}
                    alt={founder.name}
                ...
                <div className="space-y-0.5 flex-1">
                  ...
                  <p className="text-[#F97316] text-[10px] font-mono font-bold uppercase tracking-wider">
                    {founder.role}
                  </p>
                ...
                <div className="text-[#163B65]/40 pr-2">
                ...
                {isExpanded && (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="relative aspect-4/5 w-full overflow-hidden bg-[#F5F2EC] border border-[#163B65]/5">
                        <Image
                          src={founder.image}
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-[9px] font-mono font-bold tracking-widest text-[#F97316] uppercase">
                          The Philosophy
                        </span>
                      </div>

                      {/* Premium Styled Callout Quote */}
                      <div className="relative bg-[#FFFFFF] p-4 border-l-2 border-[#163B65] shadow-sm">
                        <Quote className="w-6 h-6 text-[#163B65]/5 absolute -top-1 -right-1 pointer-events-none" />
                        <p className="font-serif italic text-xs text-[#163B65] leading-relaxed">
                          &ldquo;{founder.signatureQuote}&rdquo;
                        </p>
                      </div>
                      ...
                      <div className="space-y-3 pt-1">
                        ...
                        <div className="pt-2 border-t border-[#163B65]/5 flex flex-col gap-0.5">
                          <span className="text-[9px] font-mono uppercase font-bold text-[#163B65]">
