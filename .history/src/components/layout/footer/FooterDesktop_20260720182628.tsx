  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-16 py-24">
        ...
        >
          <span className="font-luxury-meta text-xs uppercase tracking-[0.25em] text-accent">
            Smart Shopping
          </span>
          <h2 className="font-luxury-heading mt-4 text-4xl leading-[1.15] font-light tracking-tight text-text-primary xl:text-5xl">
            Building Retail <br />
            <span className="italic font-normal">Beyond Metro Cities.</span>
          </h2>
          <p className="font-luxury-nav mt-6 max-w-2xl text-base leading-relaxed text-text-secondary">
            Smart Shopping is North India’s premier multi-brand retail and
            franchise ecosystem. We curate world-class global fashion
            destinations across Tier-2 and Tier-3 landscapes, fostering
            high-growth corporate partnerships and exceptional customer
            journeys.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          custom={1}
          variants={fadeUpVariant}
          className="my-16 h-px w-full bg-border-main"
        />
