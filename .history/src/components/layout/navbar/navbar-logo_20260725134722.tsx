...
export const NavbarLogo = memo(function NavbarLogo() {
  ...
  return (
    <Link
      ...
      className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-4 rounded-sm block select-none"
    >
      <motion.div
      ...
      >
        {!error ? (
          ...
          <span className="font-serif font-extrabold text-[16px] sm:text-[19px] tracking-tight text-text-primary flex items-center gap-x-1">
