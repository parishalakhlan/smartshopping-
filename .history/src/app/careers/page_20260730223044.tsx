...
export default async function CareersPage() {
  ...
  return (
    <div className="w-full  font-sans antialiased  overflow-x-hidden min-h-screen">
      ...
      */}
      <WhyJoinSection gallery={gallery} />
