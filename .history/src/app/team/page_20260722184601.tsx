    ...
    <main className="min-h-screen ">
      ...
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/interior/interiro4.webp" // Use an interior/office image
            alt="Our Team"
            fill
            className="object-cover opacity-20"
            sizes="100vw"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-background-main via-background-main/95 to-background-main" />
        </div>
