        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-left space-y-4">
          ...
          <p className="text-sm sm:text-base font-normal max-w-xl leading-relaxed pt-2">
            {data?.hero?.description ||
              "Behind every Smart Shopping store is a dedicated team committed to delivering exceptional customer experiences, building trusted partnerships and bringing premium fashion closer to every community we serve."}
          </p>
        </div>
      </section>
