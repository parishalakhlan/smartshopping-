      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="relative max-w-4xl mx-auto">
          <motion.div
            ...
            className="w-full overflow-hidden border-2 border-border-main bg-background-secondary rounded-sm shadow-md hover:border-border-strong transition-all group cursor-pointer"
          >
            <Image
