...
> = ({ data }) => {
  ...
  }, [deptFilter, locFilter, expFilter, data]);
                        ...
                        >
                          <div className="p-6 space-y-6">
                            ...
                            <div className="pt-4 border-t border-border-main">
                              <MagneticButton className="px-6 py-3 bg-button-primary-bg text-button-primary-text hover:bg-primary-hover flex items-center gap-2">
                                Apply Now{" "}
