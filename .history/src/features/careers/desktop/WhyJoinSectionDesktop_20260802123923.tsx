      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="relative max-w-4xl mx-auto">
          <motion.div
            ...
            className="relative w-full h-[500px] sm:h-[600px] cursor-pointer overflow-hidden border-2 border-border-main bg-background-secondary rounded-sm shadow-md hover:border-border-strong transition-all group"
          >
            <Image
