...
export const HeroSectionMobile: React.FC = () => {
  ...
  return (
    <section className="relative w-full max-w-full box-border min-h-[70vh] bg-background-main flex flex-col justify-between overflow-hidden px-5 sm:px-6 py-3 font-sans lg:hidden border-b-2 border-border-main">
