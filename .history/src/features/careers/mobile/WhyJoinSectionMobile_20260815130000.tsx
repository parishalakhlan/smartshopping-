...
type WhyJoinSectionMobileProps = {
  gallery: CareersGalleryData;
};

export const WhyJoinSectionMobile: React.FC<WhyJoinSectionMobileProps> = ({
  gallery,
}) => {
  ...
  return (
    <section className="w-full bg-background-main py-12 px-4 border-b border-border-main lg:hidden selection:bg-accent selection:text-text-inverse">
      <div className="space-y-6">
        ...
        <div className="relative aspect-[4/3] w-full bg-background-secondary border-2 border-border-main rounded-sm overflow-hidden shadow-md touch-pan-y">
