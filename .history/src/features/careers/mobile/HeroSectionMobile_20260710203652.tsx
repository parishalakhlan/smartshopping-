...
export const HeroSectionMobile: React.FC<MobileProps> = ({
  ...
  return (
    <section className="relative w-full h-[90vh] bg-[#FFFFFF] flex flex-col justify-between overflow-hidden px-4 py-8 font-sans lg:hidden">
      ...
      <div className="relative z-10 w-full text-left pt-4">
        <span className="text-[9px] text-[#F97316] font-bold tracking-[0.35em] uppercase block">
          The Foundation
        </span>
      </div>
      ...
      <div className="relative z-10 w-full text-left space-y-4 my-auto">
        <h1 className="font-serif text-4xl font-bold tracking-tight text-[#163B65] leading-[1.1]">
          Grow With <br />
          <span className="italic font-normal text-[#F97316]">
            Smart Shopping
          </span>
        </h1>
        <p className="text-[#475569] text-xs font-normal max-w-xs leading-relaxed">
      ...
      <div className="relative z-10 w-full space-y-4 pb-4">
        <MagneticButtonMobile
          ...
          className="bg-[#163B65] text-[#FFFFFF] border-[#163B65] font-bold"
        >
          Start Your Journey
