...
import { formatPostedTime } from "@/features/careers/data/types";
                ...
                >
                  ...
                  >
                    <div className="flex flex-wrap items-center gap-1.5">
                      ...
                      <span className="text-[9px] uppercase tracking-wider font-medium bg-accent/10 text-accent px-2 py-0.5">
                        ...
                        <div className="p-4 space-y-5 text-xs">
                          ...
                          <div className="pt-2">
                            <button
                              ...
                              className="w-full py-3 bg-button-primary-bg text-button-primary-text font-medium text-xs flex items-center justify-center gap-2 rounded-none active:bg-primary-hover transition-colors"
                            >
                              Apply Now
