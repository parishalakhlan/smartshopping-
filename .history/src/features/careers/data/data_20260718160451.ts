...
export const whyJoinData: WhyJoinItem[] = [
  {
    ...
    paragraph:
      "From day one, you run spatial floor environments alongside luxury coordinators, understanding customer psychological trends in real time.",
    image: "public/employees/employee1.avif",
    insight:
      "Deep immersive sessions with global textile mills, tracking layout conversions across premium flagships.",
  },
  {
    id: "join-2",
    title: "Growing With Responsibility",
    paragraph:
      "We hand real inventory parameters, campaign layouts, and multi-lakh performance budgets to young managers who prove their strategic taste.",
    image:
      "https://images.unsplash.com/photo-1558583055-d74f67d86296?auto=format&fit=crop&q=80&w=1000",
    insight:
      "Structured leadership pathways tracking promotion metrics on a clear quarterly cycle.",
  },
  {
    id: "join-3",
    title: "Working With Premium Brands",
    paragraph:
      "Curate layout standards, collection launches, and sensory merchandising matrices for globally respected apparel houses.",
    image:
      "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=1000",
    insight:
      "Direct execution pipelines interacting with international distribution managers.",
  },
];
