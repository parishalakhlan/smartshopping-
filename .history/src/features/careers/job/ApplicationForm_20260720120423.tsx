...
import { ResumeUploader } from "@/features/careers/job/ResumeUploader";
import {
  validateForm,
...
import { submitApplication } from "@/features/careers/job/submitApplication";
...
export const ApplicationForm: React.FC<FormProps> = ({
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      ...
      payload.append("department", jobDetails.department || "Not specified");
      payload.append("location", jobDetails.location || "Not specified");
      payload.append("jobType", jobDetails.jobType || "Not specified");
