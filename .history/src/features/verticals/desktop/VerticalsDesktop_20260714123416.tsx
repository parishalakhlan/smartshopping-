      ...
      <div className="relative z-10 max-w-4xl space-y-8">
        ...
        >
          <a
            ...
            className="group relative px-8 py-4 bg-accent text-button-primary-text text-sm tracking-wider font-medium overflow-hidden transition-transform duration-300 active:scale-[0.985]"
          >
      ...
      <div className="max-w-3xl mx-auto space-y-8 relative z-10">
        ...
        <div className="flex items-center justify-center gap-6 pt-4">
          <a
            ...
            className="px-8 py-4 bg-accent text-button-primary-text text-xs uppercase tracking-widest font-semibold transition-transform active:scale-[0.985] inline-block"
          >
