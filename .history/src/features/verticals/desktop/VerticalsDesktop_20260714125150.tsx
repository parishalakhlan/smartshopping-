...
function VerticalsHero() {
  ...
  return (
    <section className="relative h-screen flex items-center justify-start pl-24 pr-12 overflow-hidden bg-background-main">
      ...
      <div className="relative z-10 max-w-4xl space-y-8">
        ...
        >
          <a
            ...
            className="group relative px-8 py-4 bg-button-primary-bg text-button-primary-text text-sm tracking-wider font-medium overflow-hidden transition-transform duration-300 active:scale-[0.985]"
          >
  ...
  return (
    <section className="py-44 px-24 bg-background-secondary text-center relative overflow-hidden">
      <div className="max-w-3xl mx-auto space-y-8 relative z-10">
        <h2 className="text-4xl lg:text-5xl font-light tracking-tight text-text-primary">
