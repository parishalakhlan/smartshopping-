...
function VerticalsHero() {
  ...
  return (
    <section className="relative h-screen min-h-[600px] overflow-hidden bg-primary flex items-center border-b border-border-strong">
      {/* Background Image */}
      <div className="absolute inset-0 z-0">
        <Image
          ...
          fill
          priority
          className={`${hero.image.objectFit} ${hero.image.objectPosition} opacity-30 scale-105`}
        />
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-6 lg:px-8">
        <div className="max-w-3xl space-y-6">
          <motion.span
            ...
            className="inline-flex items-center gap-3 font-luxury-meta text-accent font-bold tracking-[0.3em]"
          >
          ...
          <motion.p
            ...
            className="text-text-inverse/80 text-base font-medium max-w-xl leading-relaxed"
          >
            {hero.description}
          </motion.p>
          ...
          <motion.div
            ...
            className="pt-12 flex gap-10"
          >
            {["Retail", "Distribution", "Franchise", "Consulting"].map(
              (item) => (
                <div key={item}>
                  <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-text-inverse/80">
                    {item}
                  </p>
...
function ClosingCTA() {
  ...
  return (
    <section className="py-24 sm:py-36 px-6 sm:px-12 bg-surface text-center relative overflow-hidden border-t-2 border-border-main transition-colors duration-300">
      <div className="max-w-4xl mx-auto space-y-8 relative z-10">
        <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-text-primary leading-[1.12] font-luxury-heading">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          <a
            ...
            className="w-full sm:w-auto px-10 py-5 bg-button-primary-bg text-button-primary-text text-xs uppercase tracking-[0.2em] font-bold border-2 border-button-primary-bg transition-all duration-300 hover:bg-primary-hover active:scale-[0.97] inline-block"
          >
            {closingCTA.ctaPrimary.label}
          </a>
          <a
            href={closingCTA.ctaSecondary.href}
            className="w-full sm:w-auto px-10 py-5 bg-card-bg text-text-primary border-2 border-border-main text-xs uppercase tracking-[0.2em] font-bold transition-all duration-300 hover:border-accent active:scale-[0.97] inline-block"
          >
      ...
      {/* Decorative Grid Background Texture */}
      <div className="absolute inset-0 bg-[radial-gradient(var(--border-main)_1px,transparent_1px)] [background-size:24px_24px] pointer-events-none opacity-25" />
    </section>
  );
}
