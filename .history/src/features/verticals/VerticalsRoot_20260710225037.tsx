...
import VerticalsDesktop from "./desktop/VerticalsDesktop";
import VerticalsMobile from "./mobile/VerticalsMobile";
...
export default function VerticalsRoot() {
  ...
  return isMobile ? <VerticalsMobile /> : <VerticalsDesktop />;
}
