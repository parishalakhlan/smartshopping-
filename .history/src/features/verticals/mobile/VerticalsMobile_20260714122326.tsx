      ...
      <div className="relative z-10 space-y-4">
        ...
        <div className="pt-2">
          <a
            ...
            className="inline-block px-6 py-3.5 bg-accent text-button-primary-text text-xs font-semibold uppercase tracking-widest"
          >
    ...
    <section className="py-24 px-6 bg-black text-center space-y-6">
      ...
      <div className="flex flex-col gap-3 pt-2">
        <a
          ...
          className="w-full bg-accent text-button-primary-text text-xs font-semibold uppercase tracking-widest py-4 text-center block transition-transform active:scale-[0.98]"
        >
