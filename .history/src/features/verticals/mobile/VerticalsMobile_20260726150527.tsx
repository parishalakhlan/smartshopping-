...
export function VerticalsHeroMobile() {
  ...
  return (
    <section className="relative min-h-[80vh] w-full max-w-full box-border flex flex-col justify-end px-5 sm:px-8 pb-10 pt-20 bg-background-main overflow-hidden font-sans">
