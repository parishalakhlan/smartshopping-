  ...
  successStories: [
    {
      id: "story-1",
      partner: "JACK & JONES",
      role: "Long-Term Brand Partner",
      challenge:
        "Expanding premium menswear into growing Tier-2 cities while maintaining the same shopping experience customers expect from metro locations.",
      journey:
        "For over a decade, Smart Shopping has partnered with JACK & JONES to establish premium retail destinations backed by experienced store operations, trained teams, and customer-focused service.",
      outcome:
        "Built a trusted presence across multiple cities, helping thousands of customers access authentic JACK & JONES collections closer to home.",
      image: {
        src: "/interior/interiro4.webp",
        alt: "JACK & JONES at Smart Shopping",
        sizes: {
          desktop: "1200px",
          mobile: "600px",
        },
...

    {
      id: "story-2",
      partner: "ONLY",
      role: "Women's Fashion Partner",
      challenge:
        "Creating premium fashion destinations where women in regional cities could experience the latest global trends without travelling to metro markets.",
      journey:
        "Through years of collaboration, Smart Shopping has successfully operated ONLY stores by combining strong retail execution with an inviting customer experience.",
      outcome:
        "Established trusted fashion destinations that continue to strengthen ONLY's presence across North India.",
      image: {
        src: "/interior/interiro7.webp",
        alt: "ONLY at Smart Shopping",
        sizes: {
          desktop: "1200px",
          mobile: "600px",
        },
...

    {
      id: "story-3",
      partner: "VERO MODA",
      role: "Premium Lifestyle Partner",
      challenge:
        "Delivering a premium in-store experience while expanding into emerging retail markets with evolving customer expectations.",
      journey:
        "Smart Shopping has worked alongside VERO MODA for many years, ensuring every showroom reflects the brand's premium identity through consistent operations and customer service.",
      outcome:
        "Built lasting customer trust and strengthened VERO MODA's reach across multiple regional markets.",
      image: {
        src: "/interior/interiro6.webp",
        alt: "VERO MODA at Smart Shopping",
        sizes: {
          desktop: "1200px",
          mobile: "600px",
        },
    ...
    {
      id: "story-4",
      partner: "SELECTED HOMME",
      role: "Premium Menswear Partner",
      challenge:
        "Introducing sophisticated international menswear to customers seeking premium quality and refined shopping experiences beyond metropolitan cities.",
      journey:
        "Smart Shopping has supported SELECTED HOMME with professionally managed retail spaces designed to deliver a seamless premium customer journey.",
      outcome:
        "Helped establish the brand as a preferred destination for premium menswear across North India.",
      image: {
        src: "/interior/interiro8.webp",
        alt: "SELECTED HOMME at Smart Shopping",
        sizes: {
          desktop: "1200px",
          mobile: "600px",
        },
    ...
    {
      id: "story-5",
      partner: "Celio • The Souled Store • And Many More",
      role: "Growing Brand Portfolio",
      challenge:
        "Helping leading fashion brands expand confidently into high-potential regional markets with dependable retail operations and local market expertise.",
      journey:
        "With the successful launch of newer partners like Celio and The Souled Store, alongside long-standing collaborations, Smart Shopping continues to build retail destinations that connect global brands with growing communities.",
      outcome:
        "A continuously expanding portfolio of trusted fashion brands, driven by long-term partnerships, operational excellence, and a shared vision for regional retail growth.",
      image: {
        src: "https://images.unsplash.com/photo-1556740749-887f6717d7e4?q=80&w=1200&auto=format&fit=crop",
        alt: "Smart Shopping Brand Portfolio",
        sizes: {
          desktop: "1200px",
          mobile: "600px",
        },
