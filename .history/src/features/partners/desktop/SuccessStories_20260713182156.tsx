...
import { successStory } from "@/features/partners/partners.data";
...
export default function SuccessStories() {
  ...
  const nextStory = () => {
    setCurrentIndex((prev) => (prev + 1) % successStory.length);
  };
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="col-span-5 relative h-full min-h-[500px]">
              <Image
                src={successStory[currentIndex].image}
                alt={successStory[currentIndex].partner}
                fill
              ...
              <div className="absolute bottom-8 left-8">
                ...
                <h3 className="text-2xl text-white font-light mt-1">
                  {successStory[currentIndex].partner}
                </h3>
                <p className="text-xs text-stone-400 mt-0.5">
                  {successStory[currentIndex].role}
                </p>
              </div>
            </div>
            ...
            <div className="col-span-7 p-12 flex flex-col justify-between space-y-12 bg-black">
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-stone-300 font-light leading-relaxed">
                    {successStory[currentIndex].challenge}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-stone-300 font-light leading-relaxed">
                    {successStory[currentIndex].journey}
                  </p>
                </div>
              </div>
              ...
              <div className="border-t border-white/10 pt-6 bg-gradient-to-r from-[#131315] to-transparent p-6 border-l-2 border-[#E25822]">
                ...
                <p className="text-xl text-white font-light mt-1 leading-normal">
                  {successStory[currentIndex].outcome}
                </p>
              </div>
            </div>
          </motion.div>
