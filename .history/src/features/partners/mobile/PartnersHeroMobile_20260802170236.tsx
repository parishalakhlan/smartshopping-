...
export default function PartnersHeroMobile({
  ...
  return (
    <section className="relative min-h-[55vh] w-full max-w-full box-border flex flex-col justify-end px-6 lg:px-8 pb-10 pt-20 bg-primary overflow-hidden border-b border-border-strong">
