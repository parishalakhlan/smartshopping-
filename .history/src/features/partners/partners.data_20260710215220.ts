...
export interface RegionData {
  ...
  vision: string;
  coordinates: { x: number; y: number }; // Percentage points for absolute mapping
}
...
export const regionalRegions: RegionData[] = [
  {
    id: "north",
    name: "North Zone",
...
export const faqs: FAQItem[] = [
  {
    id: "faq-1",
    question: "How does the inventory allocation system mitigate partner risk?",
    answer:
