...
interface StoreNetworkDesktopProps {
  config: NetworkConfig;
}

export default function StoreNetworkDesktop({
  config,
}: StoreNetworkDesktopProps) {
  const {
    section,
    description,
    flagshipLabel,
          ...
          <div className="col-span-6 relative aspect-[4/5] w-full bg-background-secondary overflow-hidden">
            ...
            >
              <Image
                ...
                className={`${image.objectFit} ${image.objectPosition} ${image.brightness} ${image.contrast}`}
          ...
          <div className="col-span-6 flex flex-col justify-center">
            ...
            <div className="flex items-center gap-x-10">
              <MotionLink
                ...
                whileHover={animation.primaryCta.whileHover}
