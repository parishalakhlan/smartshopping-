      ...
      <div className="max-w-7xl mx-auto px-8 lg:px-12">
        ...
        >
          <motion.div variants={itemVariants} className="col-span-7">
            <span className="text-[#F97316] font-sans font-medium tracking-[0.25em] text-xs uppercase block mb-4">
              {data.tagline}
            </span>
          ...
          <motion.div variants={itemVariants} className="col-span-5 pl-6">
            <p className="font-sans text-[#475569] font-normal text-lg leading-relaxed">
            ...
            return (
              ...
              >
                <div className="relative aspect-[4/5] w-full overflow-hidden bg-[#F5F2EC]">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0F172A]/30 via-transparent to-transparent opacity-60 pointer-events-none" />
                </div>

                <div className="mt-8 max-w-xl">
                  <h3 className="font-serif text-3xl text-[#163B65] font-bold mb-3">
                    {moment.title}
                  </h3>
