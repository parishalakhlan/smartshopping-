      ...
      <div className="pl-[max(2rem,calc((100vw-80rem)/2))] pr-8">
        <div className="flex flex-nowrap gap-8 overflow-x-auto scrollbar-none snap-x snap-mandatory scroll-smooth pb-4">
          {brands.map((brand, idx) => {
            const brandColor = BRAND_NAME_COLORS[brand.name];
            ...
            return (
              ...
              >
                ...
                <h3
                  className="font-serif text-2xl font-bold mb-2 brand-name"
                  style={{
                    color: brandColor || "var(--color-text-primary)",
                  }}
                >
                  {brand.name}
                </h3>
