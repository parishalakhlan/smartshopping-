...
export default function FeaturedBrandsDesktop({ brands }: { brands: Brand[] }) {
  return (
    <section className="py-32 bg-background-secondary overflow-hidden hidden md:block">
      ...
      {/* FIXED: Added flex-nowrap to prevent rows from dropping down and breaking horizontal scroll */}
      <div className="pl-[max(2rem,calc((100vw-80rem)/2))] pr-8 flex flex-nowrap gap-8 overflow-x-auto scrollbar-none snap-x snap-mandatory scroll-smooth">
