...
export default function HeroMobile({ data }: { data: HeroData }) {
  return (
    <section className="relative h-[100vh] w-full flex flex-col justify-end overflow-hidden bg-[#0F172A] md:hidden">
      ...
      <div className="absolute inset-0 z-0 select-none pointer-events-none">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#0F172A] via-[#0F172A]/85 to-[#0F172A]/30" />
      </div>
      ...
      <div className="relative z-10 w-full px-5 pb-16 pt-24 flex flex-col justify-end h-full">
        ...
        >
          <span className="inline-block text-[#F97316] font-sans font-medium tracking-[0.2em] text-xs uppercase mb-4">
            {data.tagline}
          </span>
          ...
          <p className="font-sans text-base text-[#F5F2EC]/85 font-normal mb-8 max-w-md leading-relaxed">
            {data.description}
          </p>
          ...
          <div className="flex flex-col items-stretch gap-3.5 w-full">
            <motion.a
              ...
              className="inline-flex items-center justify-center bg-[#FFFFFF] text-[#163B65] font-sans text-xs tracking-widest font-bold py-4.5 px-6 rounded-none shadow-sm text-center uppercase active:bg-[#F5F2EC]"
