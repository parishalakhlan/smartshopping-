              ...
              <AnimatePresence initial={false}>
                {isOpen && (
                  ...
                  >
                    ...
                    {/* Immersive Editorial Campaign Image (Clean scaling without extra blank borders) */}
                    <div className="relative w-full bg-background-secondary rounded-[24px] overflow-hidden mb-6">
                      <motion.div
