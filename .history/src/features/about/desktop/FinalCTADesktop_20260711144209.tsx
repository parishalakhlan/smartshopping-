...
export function FinalCTADesktop() {
  return (
    <section
      id="brand-invitation"
      className="py-36 bg-navbar-active text-white px-8 text-center relative overflow-hidden"
    >
      ...
      <div className="max-w-4xl mx-auto relative z-10 space-y-12">
        <div className="space-y-4">
          <span className="text-[11px] font-sans font-bold tracking-[0.25em] text-accent block uppercase">
        ...
        <div className="flex items-center justify-center gap-4 pt-4 max-w-md mx-auto w-full font-sans">
          <motion.a
            ...
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.98 }}
            className="w-auto h-12 inline-flex items-center justify-center bg-button-secondary-bg hover:bg-accent-hover text-button-secondary-text text-xs font-bold tracking-widest px-8 transition-colors duration-300 uppercase shrink-0"
          >
