...
export function AboutHeroDesktop() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-screen flex flex-col justify-between bg-background-secondary overflow-hidden pt-36 pb-12"
    >
      <motion.div
        style={{ y: imageY }}
      ...
      >
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-background-secondary/85 via-background-secondary/75 to-background-secondary/90" />
      </motion.div>
        ...
        >
          <div className="col-span-10">
            <motion.span
              ...
              className="text-accent font-sans font-semibold tracking-[0.25em] text-sm uppercase block mb-6"
            >
              {HERO_DATA.label}
            </motion.span>
          ...
          <div className="col-span-8 grid grid-cols-12 gap-4">
            <motion.div variants={textRevealVariants} className="col-span-11">
              <p className="font-sans text-text-secondary text-lg lg:text-xl leading-relaxed font-normal tracking-wide text-balance">
      ...
      <div className="max-w-7xl mx-auto w-full px-8 relative z-10 border-t border-border-main pt-6 mt-12 flex justify-between items-center">
        <span className="font-sans text-xs uppercase tracking-widest text-text-muted/60 font-medium">
        ...
        <motion.button
          ...
          whileHover={{ y: 3 }}
          whileTap={{ scale: 0.98 }}
          className="inline-flex items-center gap-x-2.5 font-sans text-xs font-bold uppercase tracking-widest text-text-primary hover:text-accent transition-colors duration-300 group"
        >
