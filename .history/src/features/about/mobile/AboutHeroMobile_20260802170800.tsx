...
export function AboutHeroMobile() {
  return (
    <section
      id="about-hero"
      className="relative min-h-[70vh] w-full max-w-full box-border flex flex-col justify-center px-6 py-20 bg-primary overflow-hidden border-b border-border-strong font-sans"
    >
