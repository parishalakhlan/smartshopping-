...
export function AboutHeroMobile() {
  return (
    <section
      id="about-hero"
      className="relative min-h-[65vh] w-full max-w-full box-border flex flex-col justify-center px-6 py-20 bg-primary overflow-hidden border-b border-border-strong font-sans"
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-primary/80 via-primary/60 to-primary/20" />
      ...
      {/* Foreground Content Stack - Elevated Position */}
