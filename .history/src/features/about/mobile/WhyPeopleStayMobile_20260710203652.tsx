...
export function WhyPeopleStayMobile() {
  ...
  return (
    <section
      ...
      className="py-12 px-6 bg-[#FFFFFF] md:hidden min-h-[80vh] flex flex-col justify-center overflow-hidden"
    >
        ...
        {RETENTION_DATA.retentionFields.map((item, idx) => {
          ...
          return (
            <motion.div
              ...
              className={`w-full relative overflow-hidden cursor-pointer select-none border-b border-[#163B65]/10 transition-all duration-500 ${
                isSelected
                  ? "bg-[#163B65] text-white rounded-lg shadow-xl border-none z-20"
                  : isAnySelected
            ...
            >
              ...
              <div
                className={`absolute left-0 top-0 bottom-0 w-[3px] bg-[#F97316] transition-transform duration-400 ease-out ${
                    ...
                    <motion.div
                      ...
                      className={`w-6 h-6 rounded-full border flex items-center justify-center font-mono text-[9px] font-bold shrink-0 transition-colors duration-300 ${
                        isSelected
                          ...
                          : "border-[#163B65]/10 bg-[#F5F2EC] text-[#163B65]"
                      }`}
                    >
                      {item.num}
                    </motion.div>
                    ...
                    <div className="flex flex-col overflow-hidden leading-tight">
                      <span
                        className={`text-[7px] font-mono tracking-widest uppercase font-bold tracking-wider ${
                          isSelected ? "text-white/40" : "text-[#475569]/50"
                        }`}
                      >
                        {item.label}
                      </span>
