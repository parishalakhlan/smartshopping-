...
export function FoundersStoryMobile({
  ...
  return (
    <section
      id="the-visionaries"
      className="py-16 px-5 bg-background-secondary"
    >
        ...
        <div className="p-4 flex flex-col justify-center min-h-[68px]">
          ...
          <div className="w-full flex justify-between items-center gap-4">
            <div className="flex items-center gap-3 overflow-hidden">
              ...
              <div className="relative w-9 h-9 shrink-0 overflow-hidden bg-text-primary/10 border border-border-main/5">
                <Image
                  src={imageSrc}
            ...
            {isExpanded && (
              ...
              >
                ...
                <div className="relative max-h-[220px] overflow-y-auto mt-4 pr-1 text-xs leading-relaxed font-sans space-y-4 text-white/90 scrollbar-none">
                  ...
                  <p className="italic font-serif text-base text-background-secondary font-semibold tracking-tight border-l-2 border-accent pl-3 py-0.5 my-3">
                    {FOUNDERS_DATA.quote}
                  </p>
