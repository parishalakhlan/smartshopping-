...
export function AboutHeroMobile() {
  return (
    <section
      id="about-hero"
      className="relative min-h-[70vh] w-full max-w-full box-border flex flex-col justify-end px-6 pb-10 pt-20 bg-primary overflow-hidden border-b border-border-strong font-sans"
    >
