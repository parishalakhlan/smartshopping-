...
export function ValuesWallMobile() {
  ...
  return (
    <section
      ...
      className="py-12 px-6 bg-background-secondary md:hidden min-h-[85vh] flex flex-col justify-center overflow-hidden"
    >
          ...
          return (
            <motion.div
              ...
              className={`w-full relative overflow-hidden cursor-pointer select-none transition-all duration-500 ease-out ${
                isSelected
                  ? "bg-navbar-active text-white z-20 shadow-xl"
                  : isAnySelected
                    ? "bg-background-main/40 opacity-40 scale-[0.97] blur-[0.5px] z-10 border border-border-main/5"
                    : "bg-background-main border border-border-main/5 z-10 hover:bg-background-main/90"
              }`}
            >
                  ...
                  <div className="flex items-center gap-4 overflow-hidden">
                    ...
                    <span
                      className={`font-mono text-[10px] font-bold tracking-widest ${
                        isSelected ? "text-accent" : "text-text-primary/40"
                      }`}
                    >
                      {pillar.num}
                    </span>
                  ...
                  {isSelected && (
                    ...
                    >
                      ...
                      <div className="relative mt-4 max-h-[140px] overflow-y-auto pr-1 text-[11px] leading-relaxed font-sans font-normal text-white/80 scrollbar-none">
                        ...
                        <div className="absolute bottom-0 inset-x-0 h-3 bg-gradient-to-t from-navbar-active to-transparent pointer-events-none" />
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>
