      ...
      <div className="grid grid-cols-4 gap-6">
        {team.map((member) => (
          <div
            ...
            className="group cursor-pointer bg-card-bg border border-border-main hover:border-accent transition-all duration-300 rounded-none flex flex-col justify-between"
          >
            ...
            <div className="p-5 space-y-2 text-left bg-card-bg">
              ...
              <div className="w-6 h-[1px] bg-border-strong group-hover:w-12 transition-all duration-300" />
            ...
            >
              <div>
                <div className="p-6 border-b border-border-main flex items-center justify-between bg-background-secondary/30">
                  <div className="flex items-center gap-2 text-[10px] text-text-primary font-bold tracking-widest uppercase">
                    <Compass className="w-3.5 h-3.5 text-accent" />
                    Creative Vision & Philosophy
                  </div>
                  <button
                    onClick={() => setActiveLead(null)}
                    className="p-2 hover:bg-background-secondary transition-colors text-text-primary rounded-none"
                ...
                <div className="p-8 space-y-8 text-left">
                  ...
                  <div className="space-y-5 pt-2">
                    <div className="flex gap-3.5 items-start">
                      <Heart className="w-4 h-4 text-text-primary mt-1 flex-shrink-0" />
                      <div className="space-y-1">
                    ...
                    <div className="flex gap-3.5 items-start">
                      <Sparkles className="w-4 h-4 text-text-primary mt-1 flex-shrink-0" />
                      <div className="space-y-1">
                        <h4 className="text-xs font-bold text-text-primary tracking-wider uppercase">
              ...
              <div className="p-6 bg-background-secondary text-text-muted text-[9px] font-bold text-center tracking-widest uppercase rounded-none border-t border-border-main">
