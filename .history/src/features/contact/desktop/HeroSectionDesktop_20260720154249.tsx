  ...
  return (
    ...
    >
      <div className="absolute inset-0 w-full h-full pointer-events-none z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-background-main via-background-main/90 to-transparent" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-left">
            ...
            >
              <MagneticButton
                onClick={() => scrollToSection("#connect-desktop")}
                className="px-8 py-4 bg-button-primary-bg text-button-primary-text hover:bg-primary-hover border border-button-primary-bg flex items-center gap-2 rounded-none"
              >
                {" Get In Touch "}
              ...
              <Link href="/contact">
                <MagneticButton
                  ...
                  className="px-8 py-4 bg-transparent text-text-primary border border-border-main hover:border-border-hover"
                >
                  Visit Our Stores
                </MagneticButton>
              </Link>
