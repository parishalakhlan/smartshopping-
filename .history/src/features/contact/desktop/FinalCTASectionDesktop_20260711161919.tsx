      ...
      <div className="max-w-4xl mx-auto px-8 text-center space-y-8 relative z-10">
        ...
        <div className="flex gap-4 justify-center items-center pt-2">
          <MagneticButton
            ...
            className="px-8 py-4 bg-button-secondary-bg text-button-secondary-text hover:bg-accent-hover border border-button-secondary-bg font-bold shadow-sm rounded-none"
          >
            Start a Conversation
          </MagneticButton>
          <MagneticButton
            onClick={() => scrollToSection("visit")}
            className="px-8 py-4 bg-transparent text-white border border-white/20 hover:border-white rounded-none"
          >
            Visit a Store
          </MagneticButton>
        </div>
