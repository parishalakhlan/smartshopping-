        ...
        <div className="space-y-5 text-left max-w-md">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-1 w-full">
            <button
              ...
              className="w-full sm:w-auto px-6 py-3.5 bg-button-primary-bg text-button-primary-text active:bg-primary-hover font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-2 rounded-none transition-colors"
            >
              Talk With Us
            ...
            <button
              ...
              className="w-full sm:w-auto px-6 py-3.5 bg-transparent text-text-primary border border-border-main active:bg-text-primary/5 font-bold text-xs uppercase tracking-widest text-center rounded-none transition-colors"
            >
              Find A Store
            </button>
          </div>
