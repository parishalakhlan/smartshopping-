    ...
    <section className="bg-background-main py-10 px-4 border-y border-border-main font-sans md:hidden">
      ...
      <div className="grid grid-cols-2 gap-x-4 gap-y-8">
        ...
        <div className="flex flex-col gap-2 items-start text-left group">
          <div className="p-2.5 bg-background-secondary rounded-none shrink-0">
            <MapPin className="w-4 h-4 text-accent" />
          </div>
          <div className="space-y-0.5">
            <span className="block text-2xl font-bold text-primary font-serif tracking-tight leading-none">
              8+
            </span>
