      ...
      <div className="px-6 pb-20 bg-background-main space-y-8">
        <AnimatePresence mode="popLayout">
          {filteredStores.map((store) => (
            ...
            >
              {/* Cover Image Area */}
              <div className="relative w-full h-[220px] bg-neutral-100">
                <Image
                  src={store.image.src}
                  alt={store.image.alt}
                  fill
                ...
                <div className="absolute bottom-3 right-3 bg-emerald-500/90 text-white backdrop-blur-md px-2 py-0.5 text-[8px] font-extrabold uppercase tracking-widest flex items-center gap-1">
