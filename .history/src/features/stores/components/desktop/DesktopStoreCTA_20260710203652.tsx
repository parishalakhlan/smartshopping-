...
export function DesktopStoreCTA() {
  return (
    <section className="hidden md:block bg-[#163B65] py-20 lg:py-28 px-4 sm:px-6 lg:px-8 text-center relative overflow-hidden font-sans border-t border-[#163B65]/10">
